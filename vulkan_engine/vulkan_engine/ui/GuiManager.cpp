...
void GuiManager::initialize(GLFWwindow* window, VkInstance instance, VulkanDevice* device, 
	...
	pipeline_info.MSAASamples = config_.msaaSamples;
...
void GuiManager::render(VkCommandBuffer commandBuffer, VkPipeline pipeline) {
    ImGui::Render();
    ImDrawData* draw_data = ImGui::GetDrawData();
    ImGui_ImplVulkan_RenderDrawData(draw_data, commandBuffer, pipeline);
